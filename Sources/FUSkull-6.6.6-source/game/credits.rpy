...
image mcredits_1a:
    ...
    "black"
    10.33
    Text("Fuck Skull,", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 13.0, ramplen=4, alpha=False)
image mcredits_1b:
    ypos credits_ypos
    xoffset -35
    "black"
    11.75
    Text("Wait weres my pen", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 12.0, ramplen=4, alpha=False)
image mcredits_1c:
    ypos credits_ypos
    xoffset 170
    "black"
    13.76
    Text("Wait what is this", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 15.0, ramplen=4, alpha=False)
image mcredits_2a:
    ypos credits_ypos + 50
    xoffset -226
    "black"
    19.45
    Text("HELP IM BEING TRAPED BY", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 13.0, ramplen=4, alpha=False)
image mcredits_2b:
    ypos credits_ypos + 50
    xoffset -10
    "black"
    20.9
    Text("MONIKA AND ITS ONLY LETTING ME", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 9.0, ramplen=4, alpha=False)
image mcredits_2c:
    ypos credits_ypos + 50
    xoffset 225
    "black"
    23.27
    Text("SPEAK IN A WAY I HATE", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 15.0, ramplen=4, alpha=False)
...
image mcredits_4:
    ...
    "black"
    32.9
    Text("ffffffffffffffffffff", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 9.0, ramplen=4, alpha=False)

image mcredits_5:
    ypos credits_ypos + 200
    "black"
    37.5
    Text("uuuuuuuuuuuuuuuuuuu", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 16.0, ramplen=4, alpha=False)
...
image mcredits_6a:
    ...
    "black"
    42.0
    Text("I SAID FUCKING HELP", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 10.0, ramplen=4, alpha=False)
image mcredits_6b:
    ypos credits_ypos + 250
    xoffset 85
    "black"
    43.47
    Text(" just to find that special day? Wat", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 10.0, ramplen=4, alpha=False)
...
image mcredits_1_test:
    ...
    Text("Wssssssssssssssssssss", style="monika_credits_text") with ImageDissolve("images/menu/wipeleft.png", 15.0, ramplen=4)
...
label credits2:
    ...
    show credits_text "Kade" at credits_text_scroll_left as credits_text_1
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_text "Skull" at credits_text_scroll_right as credits_text_2
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_text "Kade" at credits_text_scroll_right as credits_text_2
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_text "Kade And Dan And The Living Toombstone" at credits_text_scroll_left as credits_text_1
    $ lockedtext = "" if persistent.clear[imagenum] else "_locked"
    $ if persistent.clearall: lockedtext = "_clearall"
    $ imagenum += 1
    ...
    show credits_header "Special Thanks" at credits_text_scroll_right as credits_header_2
    show credits_text "Monika\nKade (MOD)" at credits_text_scroll_right as credits_text_2
    ...
    show credits_ts
    show credits_text "made with dicks by":
    ...
    label postcredits_loop:
        ...
        show poem_end
        $ pause()
        call screen dialog(message="This was a joke. Thanks skull, your the best person in the server :D", ok_action=Quit(confirm=False))
        return
