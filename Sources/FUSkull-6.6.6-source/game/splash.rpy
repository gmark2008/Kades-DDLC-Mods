...
init python:
    ...
    splash_message_default = "Fuk..... Im a cool kid 2017 - Skull"
...
image menu_particles:
    ...
    xpos 224
    ypos 104
    ParticleBurst("skull/image.png", explodeTime=0, numParticles=20, particleTime=2.0, particleXSpeed=6, particleYSpeed=4).sm
    particle_fadeout
...
label splashscreen:
    $ config.main_menu_music = "spook.ogg"
